...
scoreboard objectives add jollyrpg-knight-perk-strength-1 trigger
scoreboard objectives add jollyrpg-knight-perk-strength-2 trigger
scoreboard objectives add jollyrpg-knight-perk-health-1 trigger
scoreboard objectives add jollyrpg-knight-perk-health-2 trigger
scoreboard objectives add jollyrpg-knight-perk-tough-armor-1 trigger
scoreboard objectives add jollyrpg-archer-perk-fall-break-1 trigger
scoreboard objectives add jollyrpg-archer-perk-fall-break-2 trigger
